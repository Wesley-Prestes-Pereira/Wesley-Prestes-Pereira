...
![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=500&size=25&pause=1000&color=0366D6&center=true&vCenter=true&width=600&lines=Desenvolvedor+Back-end;Estudante+de+Engenharia+da+Computação;Especialista+em+Laravel+e+PHP)
...
Sou **Wesley Prestes Pereira**, estudante de **Engenharia de Computação** na UNIFATEC e **Desenvolvedor Back-end** com mais de 2 anos de experiência, atualmente contribuindo para projetos de impacto público na **Assembleia Legislativa do Paraná (ALEP)** através da Adservi. Tenho uma paixão genuína por tecnologia e desenvolvimento de software, sempre buscando criar soluções que geram valor para a sociedade.

### 🎯 **Minha Jornada:**
- 💻 **Desenvolvedor Back-end** especializado em PHP, Laravel e MySQL
- 🏛️ **Contribuidor em projetos públicos** na ALEP promovendo transparência e acessibilidade
...
- 🏛️ **Co-desenvolvedor** do novo Portal da Transparência da ALEP (2025)
- 📱 **Desenvolvimento** de aplicativo móvel em Flutter para Android
- 🔒 **Implementação** de medidas de segurança web
- 🌐 **Criação e manutenção** de sistemas web internos para processos legislativos
- 💻 **Contribuição** no site institucional da ALEP

### 🚀 **Objetivos até 2030:**
- 🤖 Especialização em **Inteligência Artificial** e Machine Learning
- 🌐 Expansão para desenvolvimento **Full-Stack**
- 📱 Aprofundamento em **desenvolvimento móvel**
...
<li style="display: flex; margin-bottom: 20px; padding: 15px; border-left: 4px solid #0366d6; background-color: #f6f8fa;">
  <div>
    <h3>👨‍💻 Desenvolvedor Back-end | <em>Adservi (ALEP)</em></h3>
    <p><strong>📅 Mai/2023 – Atual</strong></p>
    <ul>
      <li>🔹 Co-desenvolvedor do <strong>Portal da Transparência da ALEP</strong> promovendo acessibilidade pública</li>
      <li>🔹 Desenvolvimento de <strong>sistemas web internos</strong> que otimizam processos legislativos</li>
      <li>🔹 Contribuição no <strong>site institucional da ALEP</strong> melhorando comunicação com a sociedade</li>
      <li>🔹 Desenvolvimento de <strong>aplicativo móvel em Flutter</strong> para Android</li>
      ...
      <li>🔹 Utilização de frameworks como <strong>Bootstrap</strong> e <strong>Bulma</strong></li>
    </ul>
  </div>
</li>
...
<li style="display: flex; margin-bottom: 20px; padding: 15px; border-left: 4px solid #28a745; background-color: #f6f8fa;">
  <div>
    ...
    <ul>
      ...
      <li>🔹 Gestão de helpdesk e suporte técnico especializado</li>
    </ul>
  </div>
</li>
...
<li style="display: flex; margin-bottom: 20px; padding: 15px; border-left: 4px solid #dc3545; background-color: #f6f8fa;">
  <div>
    ...
    <ul>
      ...
      <li>🔹 Desenvolvimento de soluções tecnológicas para otimização de processos</li>
    </ul>
  </div>
</li>
...
<div style="border: 2px solid #28a745; border-radius: 10px; padding: 20px; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); color: white;">
  ...
  <p>🎯 Curso técnico integrado ao Ensino Médio</p>
...
![Code Review](https://img.shields.io/badge/Code_Review-4ECDC4?style=for-the-badge&logo=github&logoColor=white)
...
<div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background-color: #f6f8fa;">
  ...
  <p>Co-desenvolvedor do novo Portal da Transparência da Assembleia Legislativa do Paraná, promovendo maior acessibilidade e transparência pública para os cidadãos.</p>
  <p><strong>Tech:</strong> PHP, Laravel, MySQL, JavaScript, Bootstrap</p>
  <p><strong>Impact:</strong> Transparência pública, acessibilidade</p>
</div>

<div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background-color: #f6f8fa;">
  <h3>📱 Aplicativo Mobile - Flutter</h3>
  <p>Desenvolvimento de aplicativo móvel para Android utilizando Flutter, focado em melhorar a experiência do usuário e acessibilidade mobile.</p>
  <p><strong>Tech:</strong> Flutter, Android, Dart</p>
  <p><strong>Impact:</strong> Mobilidade, experiência do usuário</p>
</div>

<div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background-color: #f6f8fa;">
  <h3>🌐 Sistemas Web Internos - ALEP</h3>
  <p>Criação e manutenção de sistemas web internos que otimizam processos legislativos, melhorando a eficiência operacional.</p>
  <p><strong>Tech:</strong> PHP, Laravel, MySQL, JavaScript</p>
  <p><strong>Impact:</strong> Otimização de processos, eficiência</p>
</div>

<div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background-color: #f6f8fa;">
  <h3>🔒 Implementação de Segurança Web</h3>
  <p>Implementação de medidas de segurança web em aplicações, garantindo proteção de dados e conformidade com padrões de segurança.</p>
  <p><strong>Tech:</strong> PHP, Laravel, Security Best Practices</p>
  <p><strong>Impact:</strong> Segurança, proteção de dados</p>
</div>
...
> **Combinação única** de experiência técnica sólida (ex-técnico em informática sênior), disciplina militar (ex-soldado do Exército Brasileiro) e visão de engenharia em formação, resultando em **soluções robustas e bem estruturadas** que geram **impacto social positivo**.

---

*Última atualização: Julho 2025* | *Sempre aberto para novas oportunidades e colaborações que transformem vidas através da tecnologia!*
